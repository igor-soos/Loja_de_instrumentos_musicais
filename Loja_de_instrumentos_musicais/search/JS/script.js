...
let time = 2500;
createSlideshow(["./img/bateria/bateria1.avif", "./img/bateria/bateria1.avif", "./img/bateria/bateria1.avif"], "slideshowImage1");
createSlideshow(["./img/microfone/microfone1.jpg", "./img/microfone/microfone2.jpg", "./img/microfone/microfone3.avif"], "slideshowImage2");
...
<div id="tabela_pontuacao"> <p id="pontuacao" >Veja abaixo os resultados com base no seu desempenho:<br><br>
1 acerto: Poderia ter sido melhor...<br>
2 acertos: Ainda pode melhorar.<br>
3 acertos: Está indo bem.<br>
4 acertos: Conhece bastante sobre música, boa!<br>
5 acertos: Parabéns, você é o mestre da música!</p></div>.`
}